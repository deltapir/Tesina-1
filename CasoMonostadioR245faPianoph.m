...
pmin=p1; % se provo a mettere una p appena appena minore di p1 mi da errore
% lascio quindi p1 come valore minimo da cui far partire le due curve
% limite della curva a campana
...
title('Diagramma p-h. Caso monostadio-R245fa','FontName','Times','FontSize',20,'FontWeight','Bold')
