...
%% CASO MONOSTADIO - R245fa
%DATI PROBLEMA % non va! problema alla linea 110 (costruzione isoentalpica)!
%possibile soluzione per il problema, che è di calcolo per refprop più che
%altro: al posto di h4 scrivi proprio il valore numerico nella linea del
%codice
...
figure (i)
 ...
 title('Diagramma T-s. Caso monostadio-R245fa','FontName','Times','FontSize',20,'FontWeight','Bold')
